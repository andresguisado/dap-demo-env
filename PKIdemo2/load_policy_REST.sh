...
main() {
  ...
  #     objects that exist on the server but omitted from the policy file
  #     will not be deleted, and any explicit deletions in the policy file will
  #     result in an error.
  # - PUT implements --replace CLI policy load flag semantics. Any policy data 
  #     which already exists on the server but is not explicitly specified in
  #     the new policy file will be deleted.
  ...
  #     data is ever implicitly deleted.
